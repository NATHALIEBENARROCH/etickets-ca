...
const SOAP_ENDPOINT =
  resolveEnv('TN_API_URL', 'TN_API_BASE', 'TN_WEBSERVICES_URL') ||
  'https://www.tn-apis.com/TNWebservices/v4/TNWebservice.asmx';
const WCID = parseInt(resolveEnv('TN_WCID', 'WCID') || '23933', 10);
...
function buildSoapEnvelope(method, params) {
  ...
  const username = resolveEnv('TN_USERNAME', 'TN_WEBSERVICES_LOGIN');
  const password = resolveEnv('TN_PASSWORD', 'TN_WEBSERVICES_PASSWORD');
  const authHeader =
    username && password
      ? `<soap:Header>
